<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AuthorManager.aspx.vb" Inherits="AuthorManager" %>
...
<body>
    ...
    <div>
        <div style="background-color: #FFE0C0; height: 100px; width: 601px; padding: 10px">
			...
			<asp:DropDownList id="lstAuthor" runat="server" Width="187px" Height="21px" AutoPostBack="True"></asp:DropDownList>&nbsp;&nbsp;&nbsp;
			...
			<asp:Button id="cmdInsert" runat="server" Width="85px" Height="24px" Text="Insert New"></asp:Button>
		</div>
		<br />
