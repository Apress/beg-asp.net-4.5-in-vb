        ...
        <table style="width: 584px" >
            <tr>
				...
				<asp:RequiredFieldValidator id="vldUserName" 
					runat="server" ErrorMessage="You must enter a user name." 
            ...
            <tr>
				...
				<asp:RequiredFieldValidator id="vldPassword" 
					runat="server" ErrorMessage="You must enter a password."
					ControlToValidate="txtPassword" Width="224px"></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td style="width: 112px">
            ...
            <tr>
				...
				<asp:RegularExpressionValidator id="vldEmail" 
					runat="server" ErrorMessage="This email is missing the @ symbol." ValidationExpression=".+@.+" ControlToValidate="txtEmail" Width="232px"></asp:RegularExpressionValidator></td>
            </tr>
            <tr>
                <td style="width: 112px">
            ...
            <tr>
				...
				<asp:CustomValidator id="vldCode" runat="server"
					...
					ControlToValidate="txtCode" ClientValidationFunction="MyCustomValidation"
					OnServerValidate="vldCode_ServerValidate" Width="232px"></asp:CustomValidator></td>
            </tr>
        </table>
        <br />
				
				<asp:Button id="cmdSubmit" 
					runat="server" Width="120px" Text="Submit" ></asp:Button>&nbsp;<asp:Button id="cmdCancel" 
					runat="server" Width="121px" Text="Cancel" CausesValidation="False" ></asp:Button></div>
        <br />
