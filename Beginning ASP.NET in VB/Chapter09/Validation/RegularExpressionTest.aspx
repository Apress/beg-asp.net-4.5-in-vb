<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RegularExpressionTest.aspx.vb" Inherits="RegularExpressionTest" %>
...
<body>
    ...
    <div>
        ...
        <asp:button id="cmdSetExpression" style="LEFT: 424px; POSITION: absolute; TOP: 48px" runat="server"  Width="138px" Text="Set This Expression" CausesValidation="False" >
        </asp:button>
