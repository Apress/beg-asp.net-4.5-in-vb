<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AdBoard.aspx.vb" Inherits="AdBoard" %>
...
<body>
    ...
    <div>
        Category:
        <asp:DropDownList ID="lstCategories" runat="server" Width="264px" 
        ...
        <asp:panel id="pnlNew" runat="server" Width="448px" style="padding: 10px"  >        	
			...
			<br />
			<asp:Button id="cmdAdd" runat="server" Width="88px" Text="Add"></asp:Button>
			<br />
		</asp:panel>
		<br />
