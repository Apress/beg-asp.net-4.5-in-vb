<%@ Page Language="VB" AutoEventWireup="false" CodeFile="SessionStateExample.aspx.vb" Inherits="SessionStateExample" %>
...
<body>
   ...
   <br /><br />
	...
	<table>
	  ...
	  <td style="padding: 10px">
	  <asp:Button id="cmdMoreInfo" Width="120px" Text="More Information" runat="server"></asp:Button>
	  <br />
	  <br />
