<%@ Page Language="VB" AutoEventWireup="false" CodeFile="WizardGreetingCardMaker.aspx.vb" Inherits="WizardGreetingCardMaker" %>
...
<body>
    ...
    <div>
        <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="0" BackColor="LemonChiffon" BorderStyle="Groove" BorderWidth="2px" CellPadding="10"  Width="456px">
            <WizardSteps>
                <asp:WizardStep ID="WizardStep1" runat="server" Title="Step 1 - Colors">
                ...
                <asp:WizardStep ID="WizardStep2" runat="server" Title="Step 2 - Background">
                ...
                <asp:WizardStep ID="WizardStep3" runat="server" Title="Step 3 - Text">
                ...
                <asp:WizardStep ID="WizardStep4" runat="server" StepType="Complete" Title="Greeting Card">
