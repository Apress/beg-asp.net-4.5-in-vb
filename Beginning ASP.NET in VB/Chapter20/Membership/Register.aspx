...
<body>
    ...
    <div>
        <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" BackColor="#EFF3FB" BorderColor="#B5C7DE"
            BorderStyle="Solid" BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em" Height="304px" Width="472px" DisplaySideBar="True">
            <WizardSteps>
                <asp:CreateUserWizardStep ID="CreateUserWizardStep1" runat="server" Title="Create User">
                </asp:CreateUserWizardStep>
                
                <asp:WizardStep ID="WizardStep1" runat="server" Title="Subscribe">                   
                        ...
                        <tr>
                            <td style="padding-right: 15px; padding-left: 15px; padding-bottom: 5px; padding-top: 15px">
                                ...
                                <asp:CheckBoxList ID="chkSubscription" runat="server">
                                    ...
                                    <asp:ListItem>High-Tech Herald</asp:ListItem>
                                </asp:CheckBoxList>         
                            </td>
                        </tr>
                    </table>
