<%@ Page Language="VB" AutoEventWireup="false" CodeFile="DetailsViewTest.aspx.vb" Inherits="DetailsViewTest" %>
...
<body>
    ...
    <div>
        <asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" CellPadding="4"
            ...
            Width="336px" AutoGenerateRows="False" DataKeyNames="ProductID" AutoGenerateEditButton="True" AutoGenerateInsertButton="True" AutoGenerateDeleteButton="true" >
