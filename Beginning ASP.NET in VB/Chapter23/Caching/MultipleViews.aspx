<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MultipleViews.aspx.vb" Inherits="MultipleViews" %>
...
<body>
    ...
    <div>
		...
		<asp:button id="cmdFilter"  runat="server" Width="112px" Text="Filter and Show" ></asp:button><br />
